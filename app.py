...
#################################################
Price_Apr21_2020_df = pd.read_csv('Price_Apr21_2020.csv')
...
Price_Apr21_2020_df.to_sql(name = 'price_apr21_2020', con = engine, if_exists = 'replace', index = False)
...
def welcome():
    ...
    return (
        ...
        f"/api/v1.0/price_apr21_2020<br/>"
...
@app.route("/api/v1.0/price_apr21_2020")
def price_station():
    ...
    price_apr21_2020 = pd.read_sql_query('select * from price_apr21_2020', con=engine)
    ...
    #price_apr21_2020_li = list(np.ravel(price_apr21_2020))
    #return jsonify(price_apr21_2020_li)
    
    return price_apr21_2020.to_json(orient='table', date_format = 'iso', index = False)
...
def price_state_geo():
    ...
    price_state = price_state.loc[(price_state.Year == 2020) & (price_state.Month == 3)]
